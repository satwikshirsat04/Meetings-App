...
//        private const val MIN_SPEECH_ENERGY = 0.02f  // Minimum energy threshold for speech
//    }
//
//    // Buffer to accumulate audio samples
//    private val audioBuffer = mutableListOf<Float>()
...
//        val floatData = FloatArray(audioData.size) { audioData[it] / 32768f }
//
//        // Check if this is actual speech (Voice Activity Detection)
//        val rmsEnergy = calculateRMS(floatData)
//        if (rmsEnergy < MIN_SPEECH_ENERGY) {
//            // Not enough energy - likely silence or noise
//            return FloatArray(0)
//        }
//
//        synchronized(audioBuffer) {
